...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // language
  var cLanguage = document.querySelector('.c-language');
  var cLanguageTrigger = document.querySelector('.c-language__trigger');
  if (cLanguage && cLanguageTrigger) {
    cLanguageTrigger.addEventListener('click', function (event) {
      event.preventDefault();
      if (cLanguage.classList.contains('is--active')) {
        cLanguage.classList.remove('is--active');
      } else {
        cLanguage.classList.add('is--active');
      }
    });
  }
